...
export default async function StaffSuggestionsPage() {
  ...
  // Get all unique questions that have suggestions for this faculty
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          View anonymous feedback and suggestions submitted by students for your questions.
        </p>
      </div>
      ...
      {questionsWithSuggestions.length === 0 ? (
        <Card className="flex flex-col items-center justify-center p-12 text-center border-dashed">
          ...
          <p className="text-sm text-muted-foreground max-w-sm mt-1">
            When students submit suggestions or point out issues in your questions, they will appear here.
          </p>
        </Card>
      ) : (
          ...
          <Table>
            <TableHeader className="bg-muted/50">
              <TableRow>
                ...
                <TableHead className="text-center min-w-[150px] border-r border-slate-300 dark:border-slate-700">Topic</TableHead>
                  ...
                  <TableCell className="text-center">
                    <div className="flex items-center justify-center gap-1 whitespace-nowrap">
                      <Button
                        ...
                        asChild
                      >
                        <Link href={`/staff/questions/${q.id}`}>
